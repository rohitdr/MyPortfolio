                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-start justify-between gap-6 py-6 text-left sm:items-center sm:py-8"
                    >
                      <h3 className="max-w-3xl pr-4 text-lg font-medium leading-7 sm:text-xl sm:leading-8">
                        {faq.question}
                      </h3>

                      <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/10 text-zinc-500">
